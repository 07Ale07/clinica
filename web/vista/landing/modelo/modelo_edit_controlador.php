    ...
    <div class="controlador-container">
        ...
        <div class="opciones-grid">
            ...
            <div class="opcion-card">
                ...
                <h2>Ubicación</h2>
                <p>Actualiza la ubicación de la clínica, mapa y direcciones.</p>
                <a href="modelo_edit_ubicacion.php" class="btn btn-primary">
            ...
            <div class="opcion-card">
                ...
                <h2>Servicios</h2>
                <p>Gestiona los servicios dentales ofrecidos y sus descripciones.</p>
                <a href="modelo_edit_servicios.php" class="btn btn-primary">
